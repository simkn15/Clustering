...
# bb is the blue box around the data points
...
combined <- plot_grid(plot_data, plt_random, ncol=2)
combined
...
# factor = 3.7
# pdf("/home/roettger/imada/research/natasa.bookchapter/pix/gap.pdf", width=2*factor, height=2*factor)
# print(combined)
# dev.off()
